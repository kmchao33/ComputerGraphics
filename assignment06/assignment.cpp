...
void initCustomResources() {
    ...
    // create the shaders:
    createShaderProgram(vs_a, fs_a, prog_a, "shader_a.vsh", "shader_a.fsh");
    createShaderProgram(vs_b, fs_b, prog_b, "shader_b.vsh", "shader_b.fsh");
    createShaderProgram(vs_c, fs_c, prog_c, "shader_c.vsh", "shader_c.fsh");
}
