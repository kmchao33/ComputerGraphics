...
GLuint vs, fs, prog;
const char *vsrc = "#version 150\n in vec4 aPosition; \n out vec3 n; \n uniform mat4 modelView; \n uniform mat4 projection; \n void main() { gl_Position = projection*modelView*aPosition; n = (transpose(inverse(mat3(modelView)))*aPosition.xyz); }\n";
const char *fsrc = "#version 150\n out vec4 oColor; \n in vec3 n; \n uniform vec3 color; void main() { oColor = vec4( dot( vec3(0,0,1),normalize(n)) * color, 1.0 ); }\n";
GLuint arrayBuffer;
GLuint vao;
...
int main( int argc, char *argv[] )
{
    ...
    do {
	 ...
	 if ((glfwGetKey(g_window, 'E') == GLFW_PRESS) && (!holdDownCKey)) {
             holdDownCKey = true;
             sceneToDraw  = 5;
         }
         if ((glfwGetKey(g_window, 'E') == GLFW_RELEASE) && (holdDownCKey)) holdDownCKey = false;
